...
```mermaid
graph TD
  965cd30e["ERC-721 NFT"]
  c60a7c94["Frontend"]
  2371855b["Wallet Auth"]
  965cd30e --> c60a7c94
  c60a7c94 --> 2371855b
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--965cd30e.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--c60a7c94.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--2371855b.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--965cd30e.md)
- [Frontend](.nskills/components/frontend-scaffold--c60a7c94.md)
- [Wallet Auth](.nskills/components/wallet-auth--2371855b.md)
